...
func registerSDKWords(r *eng.Registry, client *sdk.DorognoeSDK) {
...
func runOp(client *sdk.DorognoeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
