...
type Args struct {
	Entity string         `json:"entity" jsonschema:"city"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DorognoeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dorognoe_list",
		Description: "List records from Dorognoe. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dorognoe_load",
		Description: "Load a single record from Dorognoe. " +
...
func runOp(client *sdk.DorognoeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DorognoeSDK, name string) (sdk.DorognoeEntity, error) {
