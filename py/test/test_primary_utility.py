...
from dorognoe_sdk.core.response import DorognoeResponse
from dorognoe_sdk.core.operation import DorognoeOperation
from dorognoe_sdk.core.error import DorognoeError
from dorognoe_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DorognoeSDK.test(None, None)
        ...
        class TestInitFeature(DorognoeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DorognoeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DorognoeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DorognoeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DorognoeSDK.test(None, setup_opts)
