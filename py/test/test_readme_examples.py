# Dorognoe SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DorognoeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DorognoeSDK(...) and DorognoeSDK.test(...) become
#      DorognoeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dorognoe_sdk"
_SDK_CLASS = "DorognoeSDK"
