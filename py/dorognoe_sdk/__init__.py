...
from dorognoe_sdk.utility import register

# Load features
from dorognoe_sdk.feature.base_feature import DorognoeBaseFeature
from dorognoe_sdk.features import _has_feature, _make_feature
...
class DorognoeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DorognoeUtility()
        self._utility = utility

        from dorognoe_sdk.config import shared_config
    ...
    def get_utility(self):
        return DorognoeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DorognoeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def City(self, data=None) -> "CityEntity":
        ...
        from dorognoe_sdk.entity.city_entity import CityEntity
