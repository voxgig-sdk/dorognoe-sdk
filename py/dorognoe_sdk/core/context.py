...
from dorognoe_sdk.core.helpers import get_ctx_prop, to_map
...
class DorognoeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, DorognoeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DorognoeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DorognoeError(code, msg, self)
