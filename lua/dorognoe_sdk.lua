...
local DorognoeSDK = {}
DorognoeSDK.__index = DorognoeSDK
...
DorognoeSDK._make_feature = _make_feature


function DorognoeSDK.new(options)
  local self = setmetatable({}, DorognoeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DorognoeSDK:options_map()
...
function DorognoeSDK:get_utility()
  return Utility.copy(self._utility)
end


function DorognoeSDK:get_root_ctx()
  return self._rootctx
end


function DorognoeSDK:prepare(fetchargs)
...
function DorognoeSDK:direct(fetchargs)
...
-- by passing it.
function DorognoeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DorognoeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "DorognoeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function DorognoeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DorognoeSDK.new(sdkopts)
  sdk.mode = "test"
