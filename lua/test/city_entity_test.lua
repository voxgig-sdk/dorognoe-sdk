...
describe("CityEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DOROGNOE_TEST_CITY_ENTID JSON to run live")
      return
    end
...
function city_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DOROGNOE_TEST_CITY_ENTID")
