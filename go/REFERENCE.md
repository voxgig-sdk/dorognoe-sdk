# Dorognoe Golang SDK Reference

Complete API reference for the Dorognoe Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *DorognoeSDK`
...
#### `City(data map[string]any) DorognoeEntity`
