...
func cityBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DOROGNOE_TEST_CITY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DOROGNOE_TEST_CITY_ENTID"])
	...
	if env["DOROGNOE_TEST_LIVE"] == "TRUE" {
		...
		client = sdk.NewDorognoeSDK(core.ToMapAny(mergedOpts))
	}
	...
	return &entityTestSetup{
		...
		idmap:         idmapResolved,
		env:           env,
		explain:       env["DOROGNOE_TEST_EXPLAIN"] == "TRUE",
		live:          live,
