...
import (
	...
	vs "github.com/voxgig-sdk/dorognoe-sdk/go/utility/struct"
)

type DorognoeSDK struct {
	Mode     string
...
func (sdk *DorognoeSDK) OptionsMap() map[string]any {
...
func (sdk *DorognoeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DorognoeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DorognoeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DorognoeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DorognoeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DorognoeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DorognoeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DorognoeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DorognoeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DorognoeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
