...
func NewCityEntity(client *core.DorognoeSDK, entopts map[string]any) *CityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
