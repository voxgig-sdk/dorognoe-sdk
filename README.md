...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dorognoe-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dorognoe-sdk/releases) |
...
$citys = $client->City()->list();
print_r(array_map(fn($item) => $item->data_get(), $citys));
```
