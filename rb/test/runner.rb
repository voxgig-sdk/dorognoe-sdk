...
module DorognoeTestRunner
  ...
  def self.env_override(m)
    live = getenv("DOROGNOE_TEST_LIVE")
    override = getenv("DOROGNOE_TEST_OVERRIDE")
    ...
    explain = getenv("DOROGNOE_TEST_EXPLAIN")
    m["DOROGNOE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DorognoeTestRunner
Helpers = DorognoeHelpers
Vs = VoxgigStruct
