...
class DorognoeCacheFeature extends DorognoeBaseFeature
{
    ...
    private function _through(DorognoeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
