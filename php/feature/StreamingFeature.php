...
// Dorognoe SDK streaming feature
...
class DorognoeStreamingFeature extends DorognoeBaseFeature
{
    ...
    private function _iterate(DorognoeResult $result): \Generator
    {
    ...
    private function _streamable(DorognoeContext $ctx): bool
    {
