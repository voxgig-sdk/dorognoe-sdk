...
class DorognoeGraphql
{
    ...
    // equivalent.
    public static function body(DorognoeContext $ctx): mixed
    {
    ...
    public static function errors(DorognoeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
