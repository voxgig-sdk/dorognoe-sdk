...
// Dorognoe SDK utility: fetcher

class DorognoeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DorognoeSDK/1.0)';
    ...
    public static function call(DorognoeContext $ctx, string $fullurl, array $fetchdef): array
    {
