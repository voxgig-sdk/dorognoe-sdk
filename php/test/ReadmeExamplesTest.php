...
// Dorognoe SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DorognoeSDK::test)
...
{
    private const SDK_CLASS = 'DorognoeSDK';
    ...
    private const SDK_BASE = 'dorognoe_sdk';
