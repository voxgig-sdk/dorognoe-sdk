...
class CityEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = DorognoeSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DOROGNOE_TEST_CITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function city_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DOROGNOE_TEST_CITY_ENTID");
    ...
    if ($env["DOROGNOE_TEST_LIVE"] === "TRUE") {
        ...
        $client = new DorognoeSDK(Helpers::to_map($merged_opts));
    }
