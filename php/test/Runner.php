...
class DorognoeTestRunner
{
    ...
    {
        $live = self::getenv('DOROGNOE_TEST_LIVE');
        $override = self::getenv('DOROGNOE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DOROGNOE_TEST_EXPLAIN');
...
class_alias('DorognoeTestRunner', 'Runner');
class_alias('DorognoeHelpers', 'Helpers');
