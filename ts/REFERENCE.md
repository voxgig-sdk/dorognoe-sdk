# Dorognoe TypeScript SDK Reference

Complete API reference for the Dorognoe TypeScript SDK.
...
```ts
new DorognoeSDK(options?: object)
```
...
#### `DorognoeSDK.test(testopts?, sdkopts?)`
...
**Returns:** `DorognoeSDK` instance in test mode.
...
Return the parent `DorognoeSDK` instance.
