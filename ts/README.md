# Dorognoe TypeScript SDK



The TypeScript SDK for the Dorognoe API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.City()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `DorognoeSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DorognoeSDK.test(testopts?, sdkopts?)` | `DorognoeSDK` | Create a test-mode client. |
...
| `client` | `client(): DorognoeSDK` | Return the parent SDK client. |
