...
function liveScenariosActive() { return false && process.env.DOROGNOE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DorognoeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DOROGNOE_TEST_CITY_ENTID'];
    ...
    const client = new __1.DorognoeSDK({
        base: 'http://localhost:8080',
