...
function envOverride(m) {
    if ('TRUE' === process.env.DOROGNOE_TEST_LIVE ||
        'TRUE' === process.env.DOROGNOE_TEST_OVERRIDE) {
    ...
    m.DOROGNOE_TEST_EXPLAIN = process.env.DOROGNOE_TEST_EXPLAIN || m.DOROGNOE_TEST_EXPLAIN;
    return m;
}
