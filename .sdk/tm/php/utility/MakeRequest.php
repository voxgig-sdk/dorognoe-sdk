...
// Dorognoe SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DorognoeMakeRequest
{
    public static function call(DorognoeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DorognoeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DorognoeResponse($fetched);
        } else {
