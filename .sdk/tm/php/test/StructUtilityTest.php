...
// Dorognoe SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DorognoeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DorognoeOmni::structfix($now, Struct::undef()))
                        !== json_encode(DorognoeOmni::structfix($val, Struct::undef()))) {
