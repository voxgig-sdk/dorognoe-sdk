...
{
    private static function utility(): DorognoeUtility
    {
        return new DorognoeUtility();
    }
    ...
    private static function ctx(array $over = []): DorognoeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DorognoeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DorognoeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DorognoeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DorognoeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DorognoeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DorognoeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DorognoeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DorognoeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DorognoeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DorognoeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DorognoeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DorognoeResponse([]),
            'result' => new DorognoeResult([]),
        ]);
        [, $err] = DorognoeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DorognoeSpec([]),
            'response' => null,
            'result' => new DorognoeResult([]),
        ]);
        [, $err] = DorognoeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DorognoeSpec(['step' => 's']),
            'response' => new DorognoeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DorognoeResult([]),
        ]);
        [, $err] = DorognoeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DorognoeSpec(['step' => 's']),
            'response' => new DorognoeResponse(self::resp(200, ['v' => 1])),
            'result' => new DorognoeResult([]),
        ]);
        [, $err] = DorognoeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DorognoeSpec(['step' => 's']),
            'response' => new DorognoeResponse(self::resp(200, ['v' => 2])),
            'result' => new DorognoeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DorognoeMakeResponse::call($ctx);
    ...
    {
        $preset = new DorognoeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DorognoeSpec([]),
            'response' => new DorognoeResponse([]),
            'result' => new DorognoeResult([]),
        ...
        [$got, $err] = DorognoeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DorognoeResult([])]);
        [, $err] = DorognoeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DorognoeSpec([]), 'result' => null]);
        [, $err] = DorognoeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DorognoeSpec(['step' => 's']),
            'result' => new DorognoeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DorognoeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DorognoeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DorognoeSpec(['step' => 's']),
            'result' => new DorognoeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DorognoeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DorognoeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DorognoeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DorognoeSpec([]),
            'result' => new DorognoeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DorognoeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DorognoeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DorognoeError('boom', 'boom');
        $utility->fetcher = function (DorognoeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DorognoeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DorognoeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DorognoeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DorognoeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DorognoeResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DorognoeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DorognoeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DorognoeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DorognoeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DorognoeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DorognoeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DorognoeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DorognoeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DorognoeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DorognoeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DorognoeResult(['ok' => false])]);
        $this->expectException(DorognoeError::class);
        DorognoeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DorognoeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DorognoeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DorognoeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DorognoeBaseFeature();
        $b = new DorognoeBaseFeature();
        DorognoeFeatureAdd::call($ctx, $a);
        DorognoeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DorognoeBaseFeature
    {
        $f = new DorognoeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DorognoeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DorognoeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DorognoeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DorognoePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DorognoeResponse(['headers' => null]),
            'result' => new DorognoeResult([]),
        ]);
        DorognoeResultHeaders::call($ctx);
