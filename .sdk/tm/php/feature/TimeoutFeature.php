...
class DorognoeTimeoutFeature extends DorognoeBaseFeature
{
    ...
    private function _with_timeout(DorognoeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DorognoeContext $_ctx, float $ms): void
    {
        $client = $this->client;
