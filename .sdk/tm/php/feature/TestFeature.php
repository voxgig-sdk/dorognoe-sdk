...
// Dorognoe SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DorognoeTestFeature extends DorognoeBaseFeature
{
    ...
    public function init(DorognoeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DorognoeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DorognoeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DorognoeContext $ctx, $op, $args): array
    {
