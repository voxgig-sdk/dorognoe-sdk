...
// Dorognoe SDK clienttrack feature
...
class DorognoeClienttrackFeature extends DorognoeBaseFeature
{
    ...
    public function PostConstruct(DorognoeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Dorognoe-SDK';
