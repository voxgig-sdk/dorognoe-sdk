...
class DorognoeRbacFeature extends DorognoeBaseFeature
{
    ...
    private function _required(DorognoeContext $ctx): ?string
    {
    ...
    private function _reject(DorognoeContext $ctx, string $required): void
    {
    ...
    private function _track(DorognoeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
