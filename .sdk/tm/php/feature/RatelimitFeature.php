...
// Dorognoe SDK ratelimit feature
...
class DorognoeRatelimitFeature extends DorognoeBaseFeature
{
    ...
    private function _acquire(DorognoeContext $ctx): void
    {
    ...
    private function _track(DorognoeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
