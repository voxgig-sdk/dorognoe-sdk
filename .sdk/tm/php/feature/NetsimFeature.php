...
class DorognoeNetsimFeature extends DorognoeBaseFeature
{
    ...
    private function _simulate(DorognoeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DorognoeContext $ctx, array $applied): void
    {
        $client = $this->client;
