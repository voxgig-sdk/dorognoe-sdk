...
class DorognoeProxyFeature extends DorognoeBaseFeature
{
    ...
    public function init(DorognoeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DorognoeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
