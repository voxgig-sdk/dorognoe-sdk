...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = DorognoeOmni.make_runner(TEST_JSON_FILE, DorognoeSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : DorognoeOmni.errify(err)
    end
