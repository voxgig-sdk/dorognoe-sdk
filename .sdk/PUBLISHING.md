...
|---|---|---|
| `ts/` | @voxgig-sdk/dorognoe-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dorognoe-sdk \
      --repository voxgig-sdk/dorognoe-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dorognoe-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dorognoe-sdk --id=<id>` removes it.
